...
const ChatContainer = () => {
  ...
  return selectedUser ? (
        ...
        {messages.map((msg, index) => (
          ...
          >
            {msg.image ? (
              ...
              <p
                className={`p-2 max-w-[200px] md:text-sm font-light mb-8 break-all bg-violet-500/30 text-white rounded-lg ${
                  msg.senderId === authUser._id
                    ? "rounded-br-none"
                    : "rounded-bl-none"
                }`}
      ...
      <div className="absolute bottom-0 left-0 right-0 flex items-center gap-3 p-3">
        <div className="flex-1 flex items-center bg-gray-100/20 px-3 rounded-full">
          <input
            ...
            className="bg-white/10 rounded-lg p-3 flex-1 outline-none text-white"
          />
    ...
    <div className="flex flex-col items-center justify-center gap-2 bg-white/10">
